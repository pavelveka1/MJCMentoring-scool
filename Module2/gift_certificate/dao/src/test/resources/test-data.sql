use gift_db;
INSERT INTO `gift_certificates` (`name`,`description`,`price`,`duration`,`create_date`,`last_update_date`) VALUES ('Поeлет на дельтоплане','Полеты на мотодельтаплане дарят кристально чистый заряд адреналина и ни с чем не сравнимых впечатлений. Большое крыло, мощный двигатель и шустрые шасси — конструкция под руководством опытного пилота стремительно набирает высоту и плавает над землей на высоте 250-300 метров',1000,30, '2020-09-15 16:06:00', '2020-10-15 16:06:00');
