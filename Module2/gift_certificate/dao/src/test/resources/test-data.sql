INSERT INTO `gift_certificates` (`name`,`description`,`price`,`duration`,`create_date`,`last_update_date`) VALUES ('AПоdeлет на топлане','Полеты на мотодельтаплане дарят кристально чистый заряд адреналина и ни с чем не сравнимых впечатлений. Большое крыло, мощный двигатель и шустрые шасси — конструкция под руководством опытного пилота стремительно набирает высоту и плавает над землей на высоте 250-300 метров',1000,30, '2020-09-15 16:06:00', '2020-10-15 16:06:00');
...
INSERT INTO `gift_certificates` (`name`,`description`,`price`,`duration`,`create_date`,`last_update_date`) VALUES ('Медицefeинскиж всего тела, спины или лица','Массаж — это самый эффективный, физиологичный и приятный способ сохранить здоровье, молодость и красоту! С помощью массажа можно избавиться от боли, усталости, стресса, эмоционального напряжения',200,30, '2020-09-15 16:06:00', '2020-10-15 16:06:00');
